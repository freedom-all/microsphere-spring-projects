...
import io.github.microsphere.spring.redis.context.RedisInitializer;
import io.github.microsphere.spring.redis.event.RedisCommandEvent;
import io.github.microsphere.spring.redis.replicator.AbstractRedisReplicatorTest;
...
public class KafkaRedisReplicatorModuleInitializerTest extends AbstractRedisReplicatorTest {
    ...
    public void test() throws InterruptedException {
        ...
        context.addApplicationListener((ApplicationListener<RedisCommandReplicatedEvent>) event -> {
            ...
            Object key = keySerializer.deserialize((byte[]) redisCommandEvent.getObjectParameter(0));
